        ...
        <form action="" method="POST" encType="multipart/form-data" >
            <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                <div className="flex flex-col">
                    ...
                    <input className="border-2 rounded-lg p-3 flex border-gray-100 " type="text" name="name" />
                </div>
                <div>
                    <label className="uppercase text-sm py-2" htmlFor="">Phone Number</label>
                    <input className="border-2 rounded-lg p-3 flex border-gray-100 " type="text" name="phone" />
                </div>
            </div>
            <div>
                <label className="uppercase text-sm py-2" htmlFor="">Email</label>
                <input className="border-2 rounded-lg p-3 flex border-gray-100 " type="email" name="email"/>
            </div>
            <div>
                <label className="uppercase text-sm py-2" htmlFor="">Subject</label>
                <input className="border-2 rounded-lg p-3 flex border-gray-100 " type="text" name="subject"/>
            </div>
            <div>
