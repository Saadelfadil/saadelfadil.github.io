        ...
        <form action="" method="POST" encType="multipart/form-data" >
            <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                <div className="flex flex-col">
                    ...
                    <input className="border-2 rounded-lg  " type="text" name="name" />
                </div>
                <div>
                    <label className="uppercase text-sm py-2" htmlFor="">Phone Number</label>
                    <input className="border-2 rounded-lg  " type="text" name="phone" />
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <input className="border-2 rounded-lg  " type="text" name="subject"/>
            </div>
            <div>
