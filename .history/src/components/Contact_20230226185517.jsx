        ...
        <form action="" method="POST" encType="multipart/form-data" >
            <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                ...
                <div>
                    ...
                    <input className="border-2 rounded-lg p-3 flex  " type="text" name="phone" />
                </div>
            </div>
            <div>
                <label className="uppercase text-sm py-2" htmlFor="">Email</label>
                <input className="border-2 rounded-lg p-3 flex  " type="email" name="email"/>
            </div>
            <div>
                <label className="uppercase text-sm py-2" htmlFor="">Subject</label>
                <input className="border-2 rounded-lg p-3 flex  " type="text" name="subject"/>
            </div>
            <div>
